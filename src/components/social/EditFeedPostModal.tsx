...
import { Image as ImageIcon, X, Video, Plus, Loader2 } from "lucide-react";
...
export function EditFeedPostModal({ open, onOpenChange, post, onSaved }: EditFeedPostModalProps) {
