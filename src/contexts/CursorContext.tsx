...
export const CURSOR_OPTIONS: CursorOption[] = [
  {
    ...
    cursorHover: '/cursors/angel-purple.svg',
    particleColor: 'rgba(124, 58, 237, 1)',
  ...
  },
  {
    ...
    particleColorAlt: 'rgba(217, 119, 6, 1)',
    angelStyle: 'gold',
  },
  {
    id: 'angel-pink',
    ...
    cursor: '/cursors/angel-pink.svg',
    cursorHover: '/cursors/angel-pink.svg',
    particleColor: 'rgba(219, 39, 119, 1)',
  ...
  },
  {
    ...
    cursor: '/cursors/angel-blue.svg',
    cursorHover: '/cursors/angel-blue.svg',
    particleColor: 'rgba(29, 78, 216, 1)',
    particleColorAlt: 'rgba(59, 130, 246, 1)',
    angelStyle: 'blue',
  },
  {
    id: 'diamond',
